...
// Apply base luxury styles directly so you don't have to edit CSS
...
window.addEventListener('scroll', () => {
    ...
    // Safety cap so the bars don't overflow the screen
    if (scrollPercentage > 100) scrollPercentage = 100;
    
    // Animate all three sides simultaneously
...
// 4. CONNECT TO ADMIN DASHBOARD (Netlify CMS)
fetch('/content.json')
    .then(response => {
